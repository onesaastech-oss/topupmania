          ...
          <div className="prose prose-invert max-w-none">
            <section className={`mb-10 ${themeClasses.sectionBg} rounded-xl p-6 border ${themeClasses.sectionBorder} transition-colors duration-300`}>
              ...
              <p className={`mb-4 ${themeClasses.text}`}>
                At Topup Mania, accessible from <a href="https://topupmania.com/" className={`${themeClasses.linkColor} hover:underline`}>https://topupmania.com/</a>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Topup Mania and how we use it.
              </p>
              <p className={`mb-6 ${themeClasses.text}`}>
                If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.
              </p>
              <p className={themeClasses.text}>
                This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Topup Mania. This policy is not applicable to any information collected offline or via channels other than this website.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className={`mb-4 ${themeClasses.text}`}>
                Like any other website, Topup Mania uses "cookies". These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.
              </p>
              ...
              <p className={`mb-4 ${themeClasses.text}`}>
                You may consult this list to find the Privacy Policy for each of the advertising partners of Topup Mania.
              </p>
              <p className={`mb-4 ${themeClasses.text}`}>
                Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on Topup Mania, which are sent directly to users' browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.
              </p>
              <p className={`mb-4 ${themeClasses.text}`}>
                Note that Topup Mania has no access to or control over these cookies that are used by third-party advertisers.
              </p>
              ...
              <p className={`mb-4 ${themeClasses.text}`}>
                Topup Mania's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.
              </p>
              <p className={`mb-6 ${themeClasses.text}`}>
              ...
              <p className={`mb-6 ${themeClasses.text}`}>
                Topup Mania does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.
              </p>
